  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <hr>
		...
		<textarea class="form-control" rows="3" name="deskripsi_matkul"></textarea>
		</p>
		
		<p>
		<input type='submit' class='btn btn-success' name='submit' value="Tambah"> <a class="btn btn-warning" href="matkul.php" role="button">Kembali</a>
