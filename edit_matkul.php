  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <hr>
		...
		<input type="text" class="form-control" id="nama_matkul"  name="nama_matkul" value="<?php echo $tampil['nama_matkul']?>" >
		</p>
		
		<p>	
		<label for="deskripsi_matkul" class="form-label">Deskripsi Mata Kuliah</label>
		<textarea class="form-control" rows="3" id="deskripsi_matkul" name="deskripsi_matkul" ><?php echo $tampil['deskripsi_matkul']?></textarea>
		</p>
		
		<p>
		<input type='hidden' name='id_matkul' value="<?php echo $id_matkul?>">
		<input type='submit' class='btn btn-success' name='edit' value="Edit"> <a class="btn btn-warning" href="matkul.php" role="button">Batal</a>
